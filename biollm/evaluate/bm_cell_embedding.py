...
def cluster_metrics(X, y_pred, y_true):
    ...
    print(f"ARI: {ari} |衡量两个分区的一致性，去除随机性影响，范围 [−1,1][−1,1]，越接近 1 越好|")
    print(f"NMI: {nmi}  |计算聚类与真实标签的信息增益，范围 [0,1][0,1]，越高越好|")
    print(f"AMI: {ami}  |类似于 NMI，但去除了随机因素影响，范围 [0,1][0,1]，越高越好|")
